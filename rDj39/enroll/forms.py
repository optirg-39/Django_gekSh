...
class StudentRegistration(forms.Form):
    """If ve give empty_value then requierd error message is not needed"""
    name = forms.CharField(min_length=5,max_length=40, strip=False ,empty_value="somya",error_messages={
    ...
    feedback = forms.CharField(min_length=5, max_length=50, widget=forms.TextInput(attrs={'class':'somecss1 '
                                                                                                  'somecss2',
                                                                                          'id':'uniqueid'}))
